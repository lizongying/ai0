...
const ASSISTANTS: Record<string, Assistant> = {
    ...
    SHUSHENG: {
        id: 'shusheng',
        link: 'https://chat.intern-ai.org.cn/',
        name: '書生',
        avatar: 'shusheng.png',
        desc: '书生 (InternLM | InternVL) 是可响应人类指令的大模型 AI 助手。它不仅能与你聊天还可以搜索实时信息，帮你快速阅读论文，解答高难度数学、代码问题！快来试试吧~ | 书生大模型 - InternLM | InternVL - 上海人工智能实验室大模型',
        accept: '',
        enable: true
    },
}
